...
public class WSM_FORGOT_PASSWORD extends WSM {
    ...
    //For_pass_005, For_pass_006, For_pass_007, For_pass_008
    @Test(priority = 6)

    public void for_pass_005_006_007_008() throws InterruptedException {
        //Enter email
...
//For_pass_007 and For_pass_008: 
    ...
    @Test(priority = 13)
    public void for_pass_012() throws InterruptedException {
        //Pre-condition:
        open_changepass(wsm_email);
        change_password(cp_oldpass);
